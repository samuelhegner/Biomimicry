...
public class PredatorBird : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (activeBird == true)
        {
            if (reachedPlayer == false)
            {
                ...
                this.transform.position = Vector3.Lerp(birdStartPos, UpdatedPlayerPosition, fracJourney);
    ...
    {
        UpdatedPlayerPosition = new Vector3(PlayerTransform.position.x, PlayerTransform.position.y, 0);
